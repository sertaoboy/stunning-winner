...
console.log(multiplica(soma(1, 1))) // o terminal retorna NaN -> porque a funcao "multiplica" espera receber DOIS parametros, e como nao foi passado o segundo param. ele atribui UNDEFINED -> logo, um numero * undefined nao e um numero -> NaN. Para evitar isso pode-se definir um VALOR PADRAO para algum parametro, observar exemplo abaixo
function multiplicaPadrao(numeroI = 1, numeroII = 1) {
    return numeroI * numeroII;
}
console.log(multiplicaPadrao(soma(4, 5)))
