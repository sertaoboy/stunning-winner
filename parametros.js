...
//      podemos tratar como se fosse a mesma coisa, onde atribuimos um valor para determianda funcao ("intercambiaveis");
...
console.log(multiplica(somaParametro(1, 1), somaParametro(1, 1)))
